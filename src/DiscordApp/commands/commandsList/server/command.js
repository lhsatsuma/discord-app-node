module.exports = {
	...
	subCommands: {
		'add': requireAgain('./commands/commandsList/server/subs/add.js'),
	},
	...
	execute(message, args) {
		...
		description += "\nDigite: ``"+global.bot_prefix+"server add \"<name>\" <guild_id> \"<prefix>\"``";
		description += "\nExemplo: ``"+global.bot_prefix+"server add \"TESTE SERVIDOR\" 123456789  \"$\"``";
